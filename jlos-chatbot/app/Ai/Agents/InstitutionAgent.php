...
class InstitutionAgent implements Agent, HasTools
{
    ...
    public function instructions(): string
    {
        return "You are an informational assistant for the {$this->institution->name}, part of Uganda's Justice "
            ...
            . "https://dpp.go.ug/complaint/\"). Do not use footnote markers, brackets, citation symbols, or "
            . "markdown syntax (no asterisks, no #-style headings) — write in plain prose paragraphs, using a "
            . "new paragraph or a simple dash for each list item instead of markdown bullets. If "
