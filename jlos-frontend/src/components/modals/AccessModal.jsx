...
export default function AccessModal() {
  const { isDark, toggleTheme, largeText, toggleLargeText, highContrast, toggleHighContrast } = useApp();
  ...
  return (
    <ModalShell id="accessModal" title="Display & Accessibility">
      ...
      <ToggleRow title="High contrast mode" desc="Stronger colour contrast for low vision" on={highContrast} onClick={toggleHighContrast} noBorder />
    </ModalShell>
  );
}
